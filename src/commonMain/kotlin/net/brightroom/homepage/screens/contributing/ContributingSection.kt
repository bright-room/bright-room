...
private data class ContribStep(
    val number: String,
...
fun ContributingSection(modifier: Modifier = Modifier) {
    ...
    SectionContainer(modifier = modifier) {
        ...
        ) { step, maxHeight, onHeightMeasured, itemModifier ->
            ContribStepCard(
                step = step,
                maxCardHeight = maxHeight,
                onHeightMeasured = onHeightMeasured,
                modifier = itemModifier.widthIn(min = 220.dp),
            )
        }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(Dimensions.CardInnerPaddingLarge)) {
                Text(
